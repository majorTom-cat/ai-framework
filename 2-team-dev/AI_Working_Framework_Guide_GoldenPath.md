...
### 4.1 팀 스킬 목록 (현재 19종: 13 개발 + 6 공통 개발자 — 아래 표는 초기 스냅샷이라 일부가 빠졌을 수 있다. **최신 목록·설명의 정본 = repo README §4 표.** 최소로 시작해 실제 필요가 생긴 것만 추가된 결과)
